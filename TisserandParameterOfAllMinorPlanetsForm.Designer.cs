...
// for the TisserandParameterOfAllMinorPlanetsForm. Do not modify this file manually.
...
/// <summary>Represents a dialog form that displays the Tisserand parameter of all minor planets relative to each of the eight solar system planets.</summary>
...
partial class TisserandParameterOfAllMinorPlanetsForm
{
	...
	private void InitializeComponent()
	{
		...
		ComponentResourceManager resources = new ComponentResourceManager(typeof(TisserandParameterOfAllMinorPlanetsForm));
		...
		kryptonPanelMain.Size = new Size(1028, 411);
		...
		// listView
		// 
		listView.AccessibleDescription = "Shows the list of Tisserand parameters of all planetoids relative to the solar system planets";
		listView.AccessibleName = "Tisserand parameters of all minor planets list";
		...
		listView.Size = new Size(1028, 411);
		listView.TabIndex = 0;
		...
		kryptonStatusStrip.Size = new Size(1028, 22);
		...
		toolStripContainer.ContentPanel.Size = new Size(1028, 411);
		...
		toolStripContainer.Size = new Size(1028, 484);
		...
		// toolStripIcons
		// 
		toolStripIcons.AccessibleDescription = "Toolbar for starting and cancelling the Tisserand parameter calculation";
		...
		toolStripIcons.Size = new Size(1028, 25);
		...
		// 
		toolStripButtonStart.AccessibleDescription = "Starts the Tisserand parameter calculation for all minor planets";
		...
		// 
		toolStripButtonCancel.AccessibleDescription = "Cancels the Tisserand parameter calculation";
		...
		toolStripProgress.Size = new Size(1028, 26);
		...
		// 
		toolStripLabelProgress.AccessibleDescription = "Shows the progress of the Tisserand parameter calculation";
		...
		AccessibleName = "Tisserand parameters of all minor planets";
		AccessibleRole = AccessibleRole.Dialog;
		AutoScaleDimensions = new SizeF(7F, 15F);
		AutoScaleMode = AutoScaleMode.Font;
		ClientSize = new Size(1028, 484);
		ControlBox = false;
