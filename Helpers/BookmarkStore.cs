...
public sealed class BookmarkStore
{
	...
	/// <remarks>The bookmark file is named "bookmarks_{databaseFilename}.json" and is located in the user's application-data directory under the "Planetoid-DB\Bookmarks" sub-folder.</remarks>
	...
	public static void Save(string databaseFilename, IEnumerable<BookmarkEntry> entries)
	{
		...
		try
		{
			...
			string json = JsonSerializer.Serialize(value: entries, options: serializerOptions);
