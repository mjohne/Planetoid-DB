...
public class ToolStripNumericUpDown : ToolStripControlHost
{
	...
	/// <remarks>This event is triggered whenever the associated value is modified. Subscribers to this event can handle the change and perform necessary actions in response.</remarks>
	public event EventHandler? ValueChanged;

	/// <summary>Occurs when a key is pressed while the control has focus.</summary>
	/// <remarks>This event can be used to handle keyboard input for the control. It is important to note that this event is raised for both key down and key up actions, and can be used to implement custom keyboard shortcuts or behaviors.</remarks>
	public new event KeyEventHandler? KeyDown;

	/// <summary>Occurs when a key is pressed while the control has focus.</summary>
	/// <remarks>This event allows you to handle key press actions for the control. It is important to note that the event is raised for each key press, and you can use the event arguments to determine which key was pressed and whether any special keys (like Shift or Ctrl) were held down.</remarks>
	public new event KeyPressEventHandler? KeyPress;

	/// <summary>Occurs when a key is released while the control has focus.</summary>
	/// <remarks>This event can be used to respond to key release actions, such as validating input or triggering commands based on the released key. It is important to note that this event is raised after the KeyDown event.</remarks>
	public new event KeyEventHandler? KeyUp;

	/// <summary>Occurs when the control is being validated.</summary>
	/// <remarks>This event allows you to perform validation before the control's value is accepted. You can use the event handler to cancel the validation process if the value is not valid.</remarks>
	public new event CancelEventHandler? Validating;

	/// <summary>Occurs when the control has been successfully validated.</summary>
	/// <remarks>This event is raised after the control's validation process completes. Handle this event to perform actions that depend on the control's validated state, such as updating related UI elements or triggering business logic. The event is only raised if validation is successful.</remarks>
	public new event EventHandler? Validated;

	/// <summary>Occurs when the text content of the control changes.</summary>
	/// <remarks>This event is triggered whenever the text is modified, allowing subscribers to respond to changes in the text content. It is important to note that this event may be raised multiple times during a single user action, such as typing or pasting text.</remarks>
	public new event EventHandler? TextChanged;

	/// <summary>Occurs when the control is clicked.</summary>
	/// <remarks>This event can be used to execute custom logic in response to user interactions with the control. It is important to note that this event is a new implementation that overrides the base class's Click event.</remarks>
	public new event EventHandler? Click;

	/// <summary>Occurs when the control is double-clicked.</summary>
	/// <remarks>This event can be used to trigger actions in response to a double-click interaction. It is important to note that this event is a new implementation that overrides the base class event.</remarks>
	public new event EventHandler? DoubleClick;

	/// <summary>Occurs when the mouse is clicked over the control.</summary>
	/// <remarks>This event can be used to handle mouse click actions, allowing developers to define custom behavior when a user interacts with the control. The event provides information about the mouse button pressed and the location of the click.</remarks>
	public event MouseEventHandler? MouseClick;

	/// <summary>Occurs when the mouse pointer is double-clicked over the control.</summary>
	/// <remarks>This event can be used to trigger actions in response to a double-click, such as opening a file or editing an item. Handlers for this event should be added using the `+=` operator and removed using the `-=` operator.</remarks>
	public event MouseEventHandler? MouseDoubleClick;

	/// <summary>Occurs when the mouse button is pressed while the mouse pointer is over the control.</summary>
	/// <remarks>This event can be used to handle mouse interactions, such as initiating drag-and-drop operations or responding to user clicks. It is important to note that this event is raised only when the mouse button is pressed down, and it does not indicate the completion of a mouse action.</remarks>
	public new event MouseEventHandler? MouseDown;

	/// <summary>Occurs when the mouse pointer enters the bounds of the control.</summary>
	/// <remarks>This event can be used to trigger visual changes or actions when the mouse hovers over the control. It is important to note that this event will not be raised if the control is not visible or enabled.</remarks>
	public new event EventHandler? MouseEnter;

	/// <summary>Occurs when the mouse pointer leaves the bounds of the control.</summary>
	/// <remarks>This event can be used to trigger actions when the mouse exits the control area, such as changing visual states or updating UI elements. It is important to note that this event will not be raised if the control is not visible or if it is disabled.</remarks>
	public new event EventHandler? MouseLeave;

	/// <summary>Occurs when the mouse pointer hovers over the control.</summary>
	/// <remarks>This event can be used to trigger visual feedback or other actions when the user hovers over the control with the mouse. It is important to note that this event may not be raised if the control is not visible or enabled.</remarks>
	public new event EventHandler? MouseHover;

	/// <summary>Occurs when the mouse pointer moves over the control.</summary>
	/// <remarks>This event can be used to track mouse movements and respond accordingly, such as updating the UI or triggering actions based on the mouse position.</remarks>
	public new event MouseEventHandler? MouseMove;

	/// <summary>Occurs when the mouse button is released over the control.</summary>
	/// <remarks>This event is typically used to handle mouse interactions, allowing developers to execute code in response to the mouse button being released. It can be combined with other mouse events to create complex user interactions.</remarks>
	public new event MouseEventHandler? MouseUp;

	/// <summary>Occurs when the control receives focus.</summary>
	/// <remarks>This event can be used to execute code when the control gains focus, such as updating the UI or validating input. It is important to note that this event is raised after the control has received focus.</remarks>
	public new event EventHandler? GotFocus;

	/// <summary>Occurs when the control loses focus.</summary>
	/// <remarks>This event is typically used to perform actions when the control is no longer active, such as validating input or saving state. It can be subscribed to by adding an event handler that matches the EventHandler delegate signature.</remarks>
	public new event EventHandler? LostFocus;

	/// <summary>Occurs when the control receives input focus.</summary>
	/// <remarks>This event hides the base class event and can be used to perform actions when the control is entered, such as updating UI elements or triggering validation. It is typically raised when the user navigates to the control using the keyboard or mouse.</remarks>
	public new event EventHandler? Enter;

	/// <summary>Occurs when the control loses focus.</summary>
	/// <remarks>This event can be used to perform actions when the control is no longer active, such as validating input or saving state. It is important to note that this event is raised after the control has lost focus, allowing for any necessary cleanup or updates.</remarks>
