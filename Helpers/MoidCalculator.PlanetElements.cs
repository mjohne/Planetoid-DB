/*
 * File:        MoidCalculator.PlanetElements.cs
...
internal partial class MoidCalculator
{
	...
	internal record PlanetElements(string Name, double SemiMajorAxis, double Eccentricity, double InclinationDeg, double LongitudeAscendingNodeDeg, double ArgumentPerihelionDeg)
	{
		...
		/// <returns>A string representation of the planet elements for debugging purposes.</returns>
		/// <remarks>This property is used by the debugger to display a concise summary of the planet's orbital elements.</remarks>
