...
/// <remarks>The form provides controls for specifying the range (minimum/maximum planetoid index), starting, pausing and cancelling the download, and monitoring progress, file counts, file sizes, timing, and download errors.</remarks>
