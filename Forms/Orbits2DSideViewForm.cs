...
public partial class Orbits2DSideViewForm : BaseKryptonForm
{
	...
	/// <summary>Initializes a new instance of the <see cref="Orbits2DSideViewForm"/> class.</summary>
	...
	public Orbits2DSideViewForm(string planetoidName, double semiMajorAxis, double eccentricity, double inclinationDeg)
	{
		InitializeComponent();
		...
		logger.Info(
			message: "Orbits2DSideViewForm initialized for planetoid '{0}' (a={1} AU, e={2}, i={3}°).",
	...
	/// <remarks>
	/// <para>Each orbit is represented as a straight line through the origin (Sun). The perihelion arm of the line points in the direction of the orbital inclination (0° = positive X-axis, 90° = positive Y-axis, counterclockwise) and has length equal to the perihelion distance a·(1–e). The aphelion arm points in the opposite direction and has length a·(1+e).</para>
	/// <para>The axis limits are set to the planetoid's aphelion distance plus a small margin. Planet orbits that extend beyond this range are still drawn and can be accessed by zooming out. Both axes are scaled equally (SquareUnits) so that inclination angles appear geometrically correct.</para>
	/// </remarks>
	...
	/// <remarks>
	/// <para>The orbit is drawn as a straight line passing through the origin (Sun) from the aphelion endpoint to the perihelion endpoint:</para>
	/// <list type="bullet">
	...
	/// </list>
	/// <para>This results in the perihelion lying in the upper (positive Y) half-plane for inclinations between 0° and 180°, and the aphelion in the lower half-plane, consistent with the side-view convention.</para>
	/// </remarks>
