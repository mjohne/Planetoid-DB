/*
 * File:        AsteroidFamiliesForm.Designer.cs
...
/// <summary>Represents a Windows Form that provides a user interface for detecting, displaying, and managing asteroid families and their members within the Planetoid-DB application.</summary>
/// <remarks>AsteroidFamiliesForm enables users to view asteroid families in a hierarchical tree, examine detailed member lists, perform searches, and adjust tolerance values for orbital parameters. The form includes controls for saving family lists, monitoring search progress, and customizing detection criteria. It is designed for interactive exploration and management of asteroid family data, supporting both expert and general users. The form is not intended for use in multi-threaded scenarios and should be accessed only from the UI thread.</remarks>
partial class AsteroidFamiliesForm
{
	/// <summary>Required designer variable.</summary>
	/// <remarks>required for Windows Forms designer support - do not modify the contents of this method with the code editor.</remarks>
	...
	/// <summary>Initializes all user interface components of the AsteroidFamiliesForm, configuring controls, layout, and properties required for the form to function correctly.</summary>
	/// <remarks>This method is automatically generated by the designer and should not be called directly. It is invoked during form construction to ensure that all controls, event handlers, and resources are properly set up before the form is displayed. Modifications to UI elements should be performed in the form's constructor or appropriate event handlers rather than within this method.</remarks>
