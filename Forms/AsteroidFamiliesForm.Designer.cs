...
partial class AsteroidFamiliesForm
{
	...
	private void InitializeComponent()
	{
		...
		kryptonPanel.Controls.Add(btnSaveSelected);
		kryptonPanel.Controls.Add(btnSaveAll);
		kryptonPanel.Controls.Add(lblTolA);
		kryptonPanel.Controls.Add(numTolA);
		kryptonPanel.Controls.Add(lblTolE);
		kryptonPanel.Controls.Add(numTolE);
		kryptonPanel.Controls.Add(lblTolI);
		kryptonPanel.Controls.Add(numTolI);
		kryptonPanel.Controls.Add(lblMinMembers);
		kryptonPanel.Controls.Add(numMinMembers);
		...
		kryptonPanel.Size = new Size(1100, 650);
		...
		lblMinMembers.Size = new Size(92, 20);
		...
		listViewMembers.Size = new Size(801, 554);
