...
public partial class PlanetoidDbForm
{
	...
	/// <summary>Handles the CheckedChanged and Click events of the bookmark toolbar button and menu item to toggle the bookmark state of the current MPCORB.DAT entry.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
