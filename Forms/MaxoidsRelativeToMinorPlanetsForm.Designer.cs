/*
 * File:        MaxoidsRelativeToMinorPlanetsForm.Designer.cs
...
/// <summary>Represents a Windows Form that calculates and displays the Maximum Orbit Intersection Distance (MAXOID) between two minor planets selected by the user from the loaded database.</summary>
/// <remarks>The form presents two drop-down combo boxes — one for each minor planet — populated with all planetoid designations from the loaded database. A random-selection button sits next to each combo box. The MAXOID result is shown in a label below the combo boxes and is recalculated automatically whenever the user changes the selection in either combo box. The form does not appear in the taskbar and is intended to be used as a modal dialog.</remarks>
partial class MaxoidsRelativeToMinorPlanetsForm
{
	...
	private void InitializeComponent()
	{
		...
		ComponentResourceManager resources = new ComponentResourceManager(typeof(MaxoidsRelativeToMinorPlanetsForm));
		...
		kryptonLabelMaxoidDesc = new KryptonLabel();
		kryptonLabelMaxoidValue = new KryptonLabel();
		...
		// comboBoxPlanetoid1
		// 
		comboBoxPlanetoid1.AccessibleDescription = "Select the first minor planet for MAXOID calculation";
		...
		// comboBoxPlanetoid2
		// 
		comboBoxPlanetoid2.AccessibleDescription = "Select the second minor planet for MAXOID calculation";
		...
		kryptonLabelMaxoidDesc.Enter += Control_Enter;
		kryptonLabelMaxoidDesc.Leave += Control_Leave;
		kryptonLabelMaxoidDesc.MouseEnter += Control_Enter;
		kryptonLabelMaxoidDesc.MouseLeave += Control_Leave;
		// 
		// kryptonLabelMaxoidValue
		// 
		...
		kryptonLabelMaxoidValue.Leave += Control_Leave;
		kryptonLabelMaxoidValue.MouseEnter += Control_Enter;
		kryptonLabelMaxoidValue.MouseLeave += Control_Leave;
		// 
		// kryptonStatusStrip
		// 
		...
		// 
		// MaxoidsRelativeToMinorPlanetsForm
		// 
		AccessibleDescription = "Form for calculating the MAXOID between two minor planets";
		AccessibleName = "MAXOIDs relative to minor planets";
	...
	private KryptonLabel kryptonLabelMaxoidDesc;
	private KryptonLabel kryptonLabelMaxoidValue;
