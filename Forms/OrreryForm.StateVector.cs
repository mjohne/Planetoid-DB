/*
 * File:        OrreryForm.StateVector.cs
...
{
	/// <summary>Represents a heliocentric Cartesian state vector in the J2000 ecliptic frame.</summary>
	/// <param name="X">X coordinate in AU.</param>
	/// <param name="Y">Y coordinate in AU.</param>
	/// <param name="Z">Z coordinate in AU.</param>
	/// <param name="Vx">X velocity in AU/day.</param>
	/// <param name="Vy">Y velocity in AU/day.</param>
	/// <param name="Vz">Z velocity in AU/day.</param>
	// You can customize the debugger display for this class by providing a property that returns a string representation of the instance, which will be shown in the debugger when you inspect an object of this class. In this case, the DebuggerDisplay property is used to return a string representation of the instance, and the DebuggerDisplay attribute is applied to the class to specify that this property should be used for the debugger display.
	[DebuggerDisplay(value: $"{{{nameof(DebuggerDisplay)},nq}}")]
	private readonly record struct StateVector(double X, double Y, double Z, double Vx, double Vy, double Vz)
	{
