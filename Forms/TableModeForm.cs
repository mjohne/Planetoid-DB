/*
 * File:        TableModeForm.cs
 * Project:     Planetoid-DB
 * Namespace:   Planetoid_DB
 * Description: Represents the form for displaying planetoids data in table mode.
 *
 * Autor:       Michael Johne
...
public partial class TableModeForm : BaseKryptonForm
{
	...
	protected override string ExportFilePrefix => "Table-Mode";
