/*
 * File:        Orbit2DSideViewForm.Designer.cs
...
/// <summary>Provides a user interface for displaying a 2D side-view orbit visualization of a selected minor planet relative to the eight solar system planets.</summary>
/// <remarks>The form contains a single ScottPlot chart that renders all orbital lines in side-view perspective with a status bar below.</remarks>
partial class Orbit2DSideViewForm
{
	/// <summary>Required designer variable.</summary>
	/// <remarks>This field stores the components used by the form.</remarks>
	private IContainer components = null;

	/// <summary>Releases all resources used by the <see cref="Orbit2DSideViewForm"/>.</summary>
	...
	/// <remarks>This method sets up the controls and their properties for the Orbit2DSideViewForm. It is automatically generated by the Windows Forms designer and should not be modified manually.</remarks>
	private void InitializeComponent()
	{
		components = new Container();
		ComponentResourceManager resources = new ComponentResourceManager(typeof(Orbit2DSideViewForm));
		...
		// kryptonPanelMain
		// 
		kryptonPanelMain.AccessibleDescription = "Contains the side-view orbit diagram";
		...
		// formsPlotOrbits
		// 
		formsPlotOrbits.AccessibleDescription = "Shows the 2D side-view orbit diagram with the Sun, planet orbits, and the planetoid orbit";
		formsPlotOrbits.AccessibleName = "Side-view orbit diagram";
