/*
 * File:        MaxoidsOfAllMinorPlanetsForm.Designer.cs
 * Project:     Planetoid-DB
 * Namespace:   Planetoid_DB
 * Description: Represents a dialog form that displays the Maximum Orbit Intersection Distance (MAXOID) of all minor planets relative to each of the eight solar system planets.
 * Remarks:     This file contains the Windows Forms designer-generated code for the MaxoidsOfAllMinorPlanetsForm. Do not modify this file manually.
 *
...
/// <summary>Represents a dialog form that displays the Maximum Orbit Intersection Distance (MAXOID) of all minor planets relative to each of the eight solar system planets.</summary>
...
partial class MaxoidsOfAllMinorPlanetsForm
{
	...
	private void InitializeComponent()
	{
		...
		ComponentResourceManager resources = new ComponentResourceManager(typeof(MaxoidsOfAllMinorPlanetsForm));
		...
		// listView
		// 
		listView.AccessibleDescription = "Shows the list of MAXOIDs of all planetoids relative to the solar system planets";
		listView.AccessibleName = "MAXOIDs of all minor planets list";
		listView.AccessibleRole = AccessibleRole.List;
		listView.AllowColumnReorder = true;
		listView.Columns.AddRange(new ColumnHeader[] { columnHeaderPlanetoid, columnHeaderMercury, columnHeaderVenus, columnHeaderEarth, columnHeaderMars, columnHeaderJupiter, columnHeaderSaturn, columnHeaderUranus, columnHeaderNeptune });
		...
		// columnHeaderMercury
		// 
		columnHeaderMercury.Text = "Mercury (AU)";
		columnHeaderMercury.TextAlign = HorizontalAlignment.Right;
		columnHeaderMercury.Width = 100;
		// 
		// columnHeaderVenus
		// 
		columnHeaderVenus.Text = "Venus (AU)";
		columnHeaderVenus.TextAlign = HorizontalAlignment.Right;
		columnHeaderVenus.Width = 100;
		// 
		// columnHeaderEarth
		// 
		columnHeaderEarth.Text = "Earth (AU)";
		columnHeaderEarth.TextAlign = HorizontalAlignment.Right;
		columnHeaderEarth.Width = 100;
		// 
		// columnHeaderMars
		// 
		columnHeaderMars.Text = "Mars (AU)";
		columnHeaderMars.TextAlign = HorizontalAlignment.Right;
		columnHeaderMars.Width = 100;
		// 
		// columnHeaderJupiter
		// 
		columnHeaderJupiter.Text = "Jupiter (AU)";
		columnHeaderJupiter.TextAlign = HorizontalAlignment.Right;
		columnHeaderJupiter.Width = 100;
		// 
		// columnHeaderSaturn
		// 
		columnHeaderSaturn.Text = "Saturn (AU)";
		columnHeaderSaturn.TextAlign = HorizontalAlignment.Right;
		columnHeaderSaturn.Width = 100;
		// 
		// columnHeaderUranus
		// 
		columnHeaderUranus.Text = "Uranus (AU)";
		columnHeaderUranus.TextAlign = HorizontalAlignment.Right;
		columnHeaderUranus.Width = 100;
		// 
		// columnHeaderNeptune
		// 
		columnHeaderNeptune.Text = "Neptune (AU)";
		columnHeaderNeptune.TextAlign = HorizontalAlignment.Right;
		columnHeaderNeptune.Width = 100;
		// 
		...
		// toolStripIcons
		// 
		toolStripIcons.AccessibleDescription = "Toolbar for starting and cancelling the MAXOID calculation";
		toolStripIcons.AccessibleName = "Toolbar for starting and cancelling";
		...
		toolStripIcons.Text = "Toolbar for starting and cancelling";
		...
		// 
		toolStripButtonStart.AccessibleDescription = "Starts the MAXOID calculation for all minor planets";
		...
		// 
		toolStripButtonCancel.AccessibleDescription = "Cancels the MAXOID calculation";
		...
		// toolStripProgress
		// 
		toolStripProgress.AccessibleDescription = "Toolbar showing the calculation progress";
		toolStripProgress.AccessibleName = "Toolbar showing the calculation progress";
		...
		toolStripProgress.Text = "Toolbar showing the calculation progress";
		...
		// 
		toolStripLabelProgress.AccessibleDescription = "Shows the progress of the MAXOID calculation";
		...
		// 
		// MaxoidsOfAllMinorPlanetsForm
		// 
		AccessibleDescription = "Shows the MAXOIDs of all minor planets relative to the 8 solar system planets";
		AccessibleName = "MAXOIDs of all minor planets";
		...
		MaximizeBox = false;
		MinimizeBox = false;
		Name = "MaxoidsOfAllMinorPlanetsForm";
		StartPosition = FormStartPosition.CenterParent;
		Text = "MAXOIDs of all minor planets";
		FormClosing += MaxoidsOfAllMinorPlanetsForm_FormClosing;
		Load += MaxoidsOfAllMinorPlanetsForm_Load;
		Enter += Control_Enter;
		Leave += Control_Leave;
