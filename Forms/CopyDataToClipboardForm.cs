...
public partial class CopyDataToClipboardForm : BaseKryptonForm
{
	...
	/// <remarks>This list holds the data items that will be copied when the user interacts with the form's buttons.</remarks>
	...
	/// <summary>Fired when the CopyDataToClipboardForm loads.
	/// Clears the status area and initializes button tags with the values provided via <see cref="SetDatabase(List{string})"/>.
	/// Each button's <c>tag</c> will contain the corresponding data item or an empty string if the item is missing.</summary>
	...
	/// <summary>Handles the Click event of the buttonIndexNumber control.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
	/// <remarks>This event is used to copy the index number to the clipboard.</remarks>
	...
	/// <summary>Handles the Click event of the buttonReadableDesignation control.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
	/// <remarks>This event is used to copy the readable designation to the clipboard.</remarks>
	...
	/// <summary>Handles the Click event of the buttonEpoch control.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
	/// <remarks>This event is used to copy the epoch to the clipboard.</remarks>
	private void ButtonEpoch_Click(object sender, EventArgs e) => CopyToClipboard(text: buttonEpoch.Tag?.ToString() ?? string.Empty);

	/// <summary>Handles the Click event of the buttonMeanAnomaly control.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
	/// <remarks>This event is used to copy the mean anomaly to the clipboard.</remarks>
	...
	/// <summary>Handles the Click event of the buttonArgumentOfPerihelion control.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
	...
	/// <summary>Handles the Click event of the buttonLongitudeOfTheAscendingNode control.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
	/// <remarks>This event is used to copy the longitude of the ascending node to the clipboard.</remarks>
	...
	/// <summary>Handles the Click event of the buttonInclination control.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
	/// <remarks>This event is used to copy the inclination to the clipboard.</remarks>
	...
	/// <summary>Handles the Click event of the buttonOrbitalEccentricity control.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
	/// <remarks>This event is used to copy the orbital eccentricity to the clipboard.</remarks>
	...
	/// <summary>Handles the Click event of the buttonMeanDailyMotion control.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
	/// <remarks>This event is used to copy the mean daily motion to the clipboard.</remarks>
	...
	/// <summary>Handles the Click event of the buttonSemiMajorAxis control.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
	/// <remarks>This event is used to copy the semi-major axis to the clipboard.</remarks>
	...
	/// <summary>Handles the Click event of the buttonAbsoluteMagnitude control.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
	/// <remarks>This event is used to copy the absolute magnitude to the clipboard.</remarks>
	...
	/// <summary>Handles the Click event of the buttonSlopeParameter control.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
	/// <remarks>This event is used to copy the slope parameter to the clipboard.</remarks>
	...
	/// <summary>Handles the Click event of the buttonReference control.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
	/// <remarks>This event is used to copy the reference to the clipboard.</remarks>
	...
	/// <summary>Handles the Click event of the buttonNumberOfOppositions control.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
	/// <remarks>This event is used to copy the number of oppositions to the clipboard.</remarks>
	...
	/// <summary>Handles the Click event of the buttonNumberOfObservations control.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
	/// <remarks>This event is used to copy the number of observations to the clipboard.</remarks>
	...
	/// <summary>Handles the Click event of the buttonObservationSpan control.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
	/// <remarks>This event is used to copy the observation span to the clipboard.</remarks>
	...
	/// <summary>Handles the Click event of the buttonRmsResidual control.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
	/// <remarks>This event is used to copy the RMS residual to the clipboard.</remarks>
	...
	/// <summary>Handles the Click event of the buttonComputerName control.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
	/// <remarks>This event is used to copy the computer name to the clipboard.</remarks>
	...
	/// <summary>Handles the Click event of the buttonFlags control.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
	/// <remarks>This event is used to copy the flags to the clipboard.</remarks>
	private void ButtonFlags_Click(object sender, EventArgs e) => CopyToClipboard(text: buttonFlags.Tag?.ToString() ?? string.Empty);

	/// <summary>Handles the Click event of the buttonDateOfLastObservation control.</summary>
	/// <param name="sender">The event source.</param>
	/// <param name="e">The <see cref="EventArgs"/> instance that contains the event data.</param>
	/// <remarks>This event is used to copy the date of the last observation to the clipboard.</remarks>
