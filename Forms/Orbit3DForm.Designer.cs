...
/// <remarks>The form contains a <see cref="System.Windows.Forms.Panel"/> that hosts the OpenGL rendering surface
/// and a <see cref="KryptonStatusStrip"/> with an informational status label below.</remarks>
