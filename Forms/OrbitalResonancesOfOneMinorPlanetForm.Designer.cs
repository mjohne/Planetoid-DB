/*
 * File:        OrbitalResonancesOfOneMinorPlanetForm.Designer.cs
...
/// <summary>Represents a Windows Form that displays the orbital resonances of a minor planet relative to the eight planets in the solar system.</summary>
/// <remarks>This form provides a user interface for visualizing and interacting with orbital resonance data, including a detailed list view and a status bar for additional information. It is intended to be used as a dialog and does not appear in the taskbar. Controls are organized to facilitate accessibility and usability for exploring resonance relationships.</remarks>
