...
partial class ScatterplotsForm
{
	...
	private void InitializeComponent()
	{
		...
		// kryptonPanelMain
		// 
		kryptonPanelMain.AccessibleDescription = "Contains the scatter plot and the data points list";
		...
		// splitContainerMain
		// 
		splitContainerMain.AccessibleDescription = "Separates the scatter plot from the data points list";
		splitContainerMain.AccessibleName = "Scatter plot and list splitter";
		...
		// 
		formsPlotScatterplot.AccessibleDescription = "Shows the scatter plot of the selected orbital elements";
		...
		formsPlotScatterplot.Size = new Size(436, 436);
		...
		// listViewResults
		// 
		listViewResults.AccessibleDescription = "Shows the plotted data points as a table";
		listViewResults.AccessibleName = "Scatter plot results list";
		listViewResults.AccessibleRole = AccessibleRole.List;
		listViewResults.Columns.AddRange(new ColumnHeader[] { columnHeaderX, columnHeaderY });
		...
		// columnHeaderX
		// 
		columnHeaderX.Text = "X value";
		columnHeaderX.Width = 200;
		// 
		// columnHeaderY
		// 
		...
		// toolStripLabelXAxis
		// 
		toolStripLabelXAxis.AccessibleDescription = "Shows the selected orbital element for the X axis";
		...
		toolStripLabelXAxis.Size = new Size(37, 22);
		...
		// toolStripLabelYAxis
		// 
		toolStripLabelYAxis.AccessibleDescription = "Shows the selected orbital element for the Y axis";
		...
		toolStripLabelYAxis.Size = new Size(37, 22);
		...
		// ScatterplotsForm
		// 
		AccessibleDescription = "Plots all planetoids as a scatter plot of two user-selected orbital elements";
