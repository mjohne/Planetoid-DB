...
partial class PlanetaryInformationForm
{
	...
	private void InitializeComponent()
	{
		...
		ComponentResourceManager resources = new ComponentResourceManager(typeof(PlanetaryInformationForm));
		...
		kryptonPanelMain.Size = new Size(1000, 553);
		...
		listView.Columns.AddRange(new ColumnHeader[] { columnHeaderProperty, columnHeaderMercury, columnHeaderVenus, columnHeaderEarth, columnHeaderMars, columnHeaderJupiter, columnHeaderSaturn, columnHeaderUranus, columnHeaderNeptune });
		...
		listView.Size = new Size(1000, 553);
		listView.TabIndex = 0;
		...
		kryptonToolStripMain.Items.AddRange(new ToolStripItem[] { toolStripDropDownButtonSaveList });
		kryptonToolStripMain.Location = new Point(0, 0);
		kryptonToolStripMain.Name = "kryptonToolStripMain";
		kryptonToolStripMain.Size = new Size(1000, 25);
		kryptonToolStripMain.Stretch = true;
		kryptonToolStripMain.TabIndex = 1;
		...
		toolStripContainer.ContentPanel.Size = new Size(1000, 553);
		...
		toolStripContainer.RightToolStripPanel.AccessibleName = "Right pane";
		toolStripContainer.RightToolStripPanel.AccessibleRole = AccessibleRole.Pane;
		toolStripContainer.Size = new Size(1000, 600);
