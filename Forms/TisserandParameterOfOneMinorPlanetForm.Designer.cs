/*
 * File:        TisserandParameterOfOneMinorPlanetForm.Designer.cs
...
/// <summary>Represents a Windows Form that displays the Tisserand parameter of a minor planet relative to each of the eight solar system planets (Mercury through Neptune).</summary>
/// <remarks>The form presents data in a two-column <see cref="KryptonTableLayoutPanel"/> with eight rows — one per planet. Column 1 shows the planet name; column 2 shows the corresponding Tisserand parameter value. Export to many file formats is available through the toolbar dropdown button. The form does not appear in the taskbar and is intended to be used as a modal dialog.</remarks>
partial class TisserandParameterOfOneMinorPlanetForm
{
	...
	private void InitializeComponent()
	{
		...
		ComponentResourceManager resources = new ComponentResourceManager(typeof(TisserandParameterOfOneMinorPlanetForm));
		...
		menuitemCopyToClipboardTisserandParameterRelativeToMercury = new ToolStripMenuItem();
		menuitemCopyToClipboardTisserandParameterRelativeToVenus = new ToolStripMenuItem();
		menuitemCopyToClipboardTisserandParameterRelativeToEarth = new ToolStripMenuItem();
		menuitemCopyToClipboardTisserandParameterRelativeToMars = new ToolStripMenuItem();
		menuitemCopyToClipboardTisserandParameterRelativeToJupiter = new ToolStripMenuItem();
		menuitemCopyToClipboardTisserandParameterRelativeToSaturn = new ToolStripMenuItem();
		menuitemCopyToClipboardTisserandParameterRelativeToUranus = new ToolStripMenuItem();
		menuitemCopyToClipboardTisserandParameterRelativeToNeptune = new ToolStripMenuItem();
		...
		labelMercuryDesc.Size = new Size(61, 20);
		labelMercuryDesc.TabIndex = 0;
		labelMercuryDesc.ToolTipValues.Description = "Tisserand parameter of the minor planet relative to Mercury.\r\nDouble-click or right-click to copy the value to the clipboard.";
		...
		// 
		contextMenuCopyToClipboard.AccessibleDescription = "Shows the context menu for copying the Tisserand parameter value to the clipboard";
		...
		// 
		toolStripMenuItemCopyToClipboard.AccessibleDescription = "Copies the Tisserand parameter value to the clipboard";
		...
		labelVenusDesc.Location = new Point(3, 29);
		labelVenusDesc.Name = "labelVenusDesc";
		labelVenusDesc.Size = new Size(61, 20);
		labelVenusDesc.TabIndex = 2;
		labelVenusDesc.ToolTipValues.Description = "Tisserand parameter of the minor planet relative to Venus.\r\nDouble-click or right-click to copy the value to the clipboard.";
		...
		labelEarthDesc.Location = new Point(3, 55);
		labelEarthDesc.Name = "labelEarthDesc";
		labelEarthDesc.Size = new Size(61, 20);
		labelEarthDesc.TabIndex = 4;
		labelEarthDesc.ToolTipValues.Description = "Tisserand parameter of the minor planet relative to Earth.\r\nDouble-click or right-click to copy the value to the clipboard.";
		...
		labelMarsDesc.Location = new Point(3, 81);
		labelMarsDesc.Name = "labelMarsDesc";
		labelMarsDesc.Size = new Size(61, 20);
		labelMarsDesc.TabIndex = 6;
		labelMarsDesc.ToolTipValues.Description = "Tisserand parameter of the minor planet relative to Mars.\r\nDouble-click or right-click to copy the value to the clipboard.";
		...
		labelJupiterDesc.Location = new Point(3, 107);
		labelJupiterDesc.Name = "labelJupiterDesc";
		labelJupiterDesc.Size = new Size(61, 20);
		labelJupiterDesc.TabIndex = 8;
		labelJupiterDesc.ToolTipValues.Description = "Tisserand parameter of the minor planet relative to Jupiter.\r\nDouble-click or right-click to copy the value to the clipboard.";
		...
		labelSaturnDesc.Location = new Point(3, 133);
		labelSaturnDesc.Name = "labelSaturnDesc";
		labelSaturnDesc.Size = new Size(61, 20);
		labelSaturnDesc.TabIndex = 10;
		labelSaturnDesc.ToolTipValues.Description = "Tisserand parameter of the minor planet relative to Saturn.\r\nDouble-click or right-click to copy the value to the clipboard.";
		...
		labelUranusDesc.Location = new Point(3, 159);
		labelUranusDesc.Name = "labelUranusDesc";
		labelUranusDesc.Size = new Size(61, 20);
		labelUranusDesc.TabIndex = 12;
		labelUranusDesc.ToolTipValues.Description = "Tisserand parameter of the minor planet relative to Uranus.\r\nDouble-click or right-click to copy the value to the clipboard.";
		...
		labelNeptuneDesc.Location = new Point(3, 185);
		labelNeptuneDesc.Name = "labelNeptuneDesc";
		labelNeptuneDesc.Size = new Size(61, 20);
		labelNeptuneDesc.TabIndex = 14;
		labelNeptuneDesc.ToolTipValues.Description = "Tisserand parameter of the minor planet relative to Neptune.\r\nDouble-click or right-click to copy the value to the clipboard.";
		...
		// labelMercuryData
		// 
		labelMercuryData.AccessibleDescription = "Shows the Tisserand parameter relative to Mercury";
		labelMercuryData.AccessibleName = "Tisserand parameter relative to Mercury";
		labelMercuryData.AccessibleRole = AccessibleRole.StaticText;
		labelMercuryData.ContextMenuStrip = contextMenuCopyToClipboard;
		labelMercuryData.Dock = DockStyle.Top;
		labelMercuryData.Location = new Point(70, 3);
		labelMercuryData.Name = "labelMercuryData";
		labelMercuryData.Size = new Size(211, 20);
		labelMercuryData.TabIndex = 1;
		labelMercuryData.ToolTipValues.Description = "Shows the Tisserand parameter relative to Mercury.\r\nDouble-click or right-click to copy the value to the clipboard.";
		labelMercuryData.ToolTipValues.EnableToolTips = true;
		labelMercuryData.ToolTipValues.Heading = "Tisserand parameter relative to Mercury";
		...
		// labelVenusData
		// 
		labelVenusData.AccessibleDescription = "Shows the Tisserand parameter relative to Venus";
		labelVenusData.AccessibleName = "Tisserand parameter relative to Venus";
		labelVenusData.AccessibleRole = AccessibleRole.StaticText;
		labelVenusData.ContextMenuStrip = contextMenuCopyToClipboard;
		labelVenusData.Dock = DockStyle.Top;
		labelVenusData.Location = new Point(70, 29);
		labelVenusData.Name = "labelVenusData";
		labelVenusData.Size = new Size(211, 20);
		labelVenusData.TabIndex = 3;
		labelVenusData.ToolTipValues.Description = "Shows the Tisserand parameter relative to Venus.\r\nDouble-click or right-click to copy the value to the clipboard.";
		labelVenusData.ToolTipValues.EnableToolTips = true;
		labelVenusData.ToolTipValues.Heading = "Tisserand parameter relative to Venus";
		...
		// labelEarthData
		// 
		labelEarthData.AccessibleDescription = "Shows the Tisserand parameter relative to Earth";
		labelEarthData.AccessibleName = "Tisserand parameter relative to Earth";
		labelEarthData.AccessibleRole = AccessibleRole.StaticText;
		labelEarthData.ContextMenuStrip = contextMenuCopyToClipboard;
		labelEarthData.Dock = DockStyle.Top;
		labelEarthData.Location = new Point(70, 55);
		labelEarthData.Name = "labelEarthData";
		labelEarthData.Size = new Size(211, 20);
		labelEarthData.TabIndex = 5;
		labelEarthData.ToolTipValues.Description = "Shows the Tisserand parameter relative to Earth.\r\nDouble-click or right-click to copy the value to the clipboard.";
		labelEarthData.ToolTipValues.EnableToolTips = true;
		labelEarthData.ToolTipValues.Heading = "Tisserand parameter relative to Earth";
		...
		// labelMarsData
		// 
		labelMarsData.AccessibleDescription = "Shows the Tisserand parameter relative to Mars";
		labelMarsData.AccessibleName = "Tisserand parameter relative to Mars";
		labelMarsData.AccessibleRole = AccessibleRole.StaticText;
		labelMarsData.ContextMenuStrip = contextMenuCopyToClipboard;
		labelMarsData.Dock = DockStyle.Top;
		labelMarsData.Location = new Point(70, 81);
		labelMarsData.Name = "labelMarsData";
		labelMarsData.Size = new Size(211, 20);
		labelMarsData.TabIndex = 7;
		labelMarsData.ToolTipValues.Description = "Shows the Tisserand parameter relative to Mars.\r\nDouble-click or right-click to copy the value to the clipboard.";
		labelMarsData.ToolTipValues.EnableToolTips = true;
		labelMarsData.ToolTipValues.Heading = "Tisserand parameter relative to Mars";
		...
		// labelJupiterData
		// 
		labelJupiterData.AccessibleDescription = "Shows the Tisserand parameter relative to Jupiter";
		labelJupiterData.AccessibleName = "Tisserand parameter relative to Jupiter";
		labelJupiterData.AccessibleRole = AccessibleRole.StaticText;
		labelJupiterData.ContextMenuStrip = contextMenuCopyToClipboard;
		labelJupiterData.Dock = DockStyle.Top;
		labelJupiterData.Location = new Point(70, 107);
		labelJupiterData.Name = "labelJupiterData";
		labelJupiterData.Size = new Size(211, 20);
		labelJupiterData.TabIndex = 9;
		labelJupiterData.ToolTipValues.Description = "Shows the Tisserand parameter relative to Jupiter.\r\nDouble-click or right-click to copy the value to the clipboard.";
		labelJupiterData.ToolTipValues.EnableToolTips = true;
		labelJupiterData.ToolTipValues.Heading = "Tisserand parameter relative to Jupiter";
		...
		// labelSaturnData
		// 
		labelSaturnData.AccessibleDescription = "Shows the Tisserand parameter relative to Saturn";
		labelSaturnData.AccessibleName = "Tisserand parameter relative to Saturn";
		labelSaturnData.AccessibleRole = AccessibleRole.StaticText;
		labelSaturnData.ContextMenuStrip = contextMenuCopyToClipboard;
		labelSaturnData.Dock = DockStyle.Top;
		labelSaturnData.Location = new Point(70, 133);
		labelSaturnData.Name = "labelSaturnData";
		labelSaturnData.Size = new Size(211, 20);
		labelSaturnData.TabIndex = 11;
		labelSaturnData.ToolTipValues.Description = "Shows the Tisserand parameter relative to Saturn.\r\nDouble-click or right-click to copy the value to the clipboard.";
		labelSaturnData.ToolTipValues.EnableToolTips = true;
		labelSaturnData.ToolTipValues.Heading = "Tisserand parameter relative to Saturn";
		...
		// labelUranusData
		// 
		labelUranusData.AccessibleDescription = "Shows the Tisserand parameter relative to Uranus";
		labelUranusData.AccessibleName = "Tisserand parameter relative to Uranus";
		labelUranusData.AccessibleRole = AccessibleRole.StaticText;
		labelUranusData.ContextMenuStrip = contextMenuCopyToClipboard;
		labelUranusData.Dock = DockStyle.Top;
		labelUranusData.Location = new Point(70, 159);
		labelUranusData.Name = "labelUranusData";
		labelUranusData.Size = new Size(211, 20);
		labelUranusData.TabIndex = 13;
		labelUranusData.ToolTipValues.Description = "Shows the Tisserand parameter relative to Uranus.\r\nDouble-click or right-click to copy the value to the clipboard.";
		labelUranusData.ToolTipValues.EnableToolTips = true;
		labelUranusData.ToolTipValues.Heading = "Tisserand parameter relative to Uranus";
		...
		// labelNeptuneData
		// 
		labelNeptuneData.AccessibleDescription = "Shows the Tisserand parameter relative to Neptune";
		labelNeptuneData.AccessibleName = "Tisserand parameter relative to Neptune";
		labelNeptuneData.AccessibleRole = AccessibleRole.StaticText;
		labelNeptuneData.ContextMenuStrip = contextMenuCopyToClipboard;
		labelNeptuneData.Dock = DockStyle.Top;
		labelNeptuneData.Location = new Point(70, 185);
		labelNeptuneData.Name = "labelNeptuneData";
		labelNeptuneData.Size = new Size(211, 20);
		labelNeptuneData.TabIndex = 15;
		labelNeptuneData.ToolTipValues.Description = "Shows the Tisserand parameter relative to Neptune.\r\nDouble-click or right-click to copy the value to the clipboard.";
		labelNeptuneData.ToolTipValues.EnableToolTips = true;
		labelNeptuneData.ToolTipValues.Heading = "Tisserand parameter relative to Neptune";
		...
		toolStripContainer.ContentPanel.Size = new Size(284, 212);
		...
		toolStripContainer.Size = new Size(284, 259);
		...
		// tableLayoutPanel
		// 
		tableLayoutPanel.AccessibleDescription = "Table showing Tisserand parameter values per planet";
		tableLayoutPanel.AccessibleName = "Tisserand parameter table";
		...
		tableLayoutPanel.RowStyles.Add(new RowStyle());
		tableLayoutPanel.RowStyles.Add(new RowStyle());
		tableLayoutPanel.Size = new Size(284, 212);
		...
		// 
		contextMenuSaveToFile.AccessibleDescription = "Save the Tisserand parameter data as file";
		contextMenuSaveToFile.AccessibleName = "Save Tisserand parameter data";
		...
		toolStripMenuItemSaveAsAbiword.Text = "Save as &Abiword (ABW)";
		...
		toolStripMenuItemSaveAsWps.Text = "Save as WPS &Writer (WPS)";
		...
		menuitemCopyToClipboardTisserandParameterRelativeToMercury.AccessibleName = "Copy to clipboard: Tisserand parameter relative to Mercury";
		menuitemCopyToClipboardTisserandParameterRelativeToMercury.AccessibleRole = AccessibleRole.MenuItem;
		menuitemCopyToClipboardTisserandParameterRelativeToMercury.AutoToolTip = true;
		menuitemCopyToClipboardTisserandParameterRelativeToMercury.Image = (Image)resources.GetObject("menuitemCopyToClipboardTisserandParameterRelativeToMercury.Image");
		menuitemCopyToClipboardTisserandParameterRelativeToMercury.Name = "menuitemCopyToClipboardTisserandParameterRelativeToMercury";
		menuitemCopyToClipboardTisserandParameterRelativeToMercury.Size = new Size(120, 22);
		menuitemCopyToClipboardTisserandParameterRelativeToMercury.Text = "&Mercury";
		menuitemCopyToClipboardTisserandParameterRelativeToMercury.Click += MenuitemCopyToClipboardTisserandParameterRelativeToMercury_Click;
		menuitemCopyToClipboardTisserandParameterRelativeToMercury.MouseEnter += Control_Enter;
		menuitemCopyToClipboardTisserandParameterRelativeToMercury.MouseLeave += Control_Leave;
		// 
		// menuitemCopyToClipboardTisserandParameterRelativeToVenus
		// 
		menuitemCopyToClipboardTisserandParameterRelativeToVenus.AccessibleDescription = "Copies to clipboard: Tisserand parameter relative to Venus";
		menuitemCopyToClipboardTisserandParameterRelativeToVenus.AccessibleName = "Copy to clipboard: Tisserand parameter relative to Venus";
		menuitemCopyToClipboardTisserandParameterRelativeToVenus.AccessibleRole = AccessibleRole.MenuItem;
		menuitemCopyToClipboardTisserandParameterRelativeToVenus.AutoToolTip = true;
		menuitemCopyToClipboardTisserandParameterRelativeToVenus.Image = (Image)resources.GetObject("menuitemCopyToClipboardTisserandParameterRelativeToVenus.Image");
		menuitemCopyToClipboardTisserandParameterRelativeToVenus.Name = "menuitemCopyToClipboardTisserandParameterRelativeToVenus";
		menuitemCopyToClipboardTisserandParameterRelativeToVenus.Size = new Size(120, 22);
		menuitemCopyToClipboardTisserandParameterRelativeToVenus.Text = "&Venus";
		menuitemCopyToClipboardTisserandParameterRelativeToVenus.Click += MenuitemCopyToClipboardTisserandParameterRelativeToVenus_Click;
		menuitemCopyToClipboardTisserandParameterRelativeToVenus.MouseEnter += Control_Enter;
		menuitemCopyToClipboardTisserandParameterRelativeToVenus.MouseLeave += Control_Leave;
		// 
		// menuitemCopyToClipboardTisserandParameterRelativeToEarth
		// 
		menuitemCopyToClipboardTisserandParameterRelativeToEarth.AccessibleDescription = "Copies to clipboard: Tisserand parameter relative to Earth";
		menuitemCopyToClipboardTisserandParameterRelativeToEarth.AccessibleName = "Copy to clipboard: Tisserand parameter relative to Earth";
		menuitemCopyToClipboardTisserandParameterRelativeToEarth.AccessibleRole = AccessibleRole.MenuItem;
		menuitemCopyToClipboardTisserandParameterRelativeToEarth.AutoToolTip = true;
		menuitemCopyToClipboardTisserandParameterRelativeToEarth.Image = (Image)resources.GetObject("menuitemCopyToClipboardTisserandParameterRelativeToEarth.Image");
		menuitemCopyToClipboardTisserandParameterRelativeToEarth.Name = "menuitemCopyToClipboardTisserandParameterRelativeToEarth";
		menuitemCopyToClipboardTisserandParameterRelativeToEarth.Size = new Size(120, 22);
		menuitemCopyToClipboardTisserandParameterRelativeToEarth.Text = "&Earth";
		menuitemCopyToClipboardTisserandParameterRelativeToEarth.Click += MenuitemCopyToClipboardTisserandParameterRelativeToEarth_Click;
		menuitemCopyToClipboardTisserandParameterRelativeToEarth.MouseEnter += Control_Enter;
		menuitemCopyToClipboardTisserandParameterRelativeToEarth.MouseLeave += Control_Leave;
		// 
		// menuitemCopyToClipboardTisserandParameterRelativeToMars
		// 
		menuitemCopyToClipboardTisserandParameterRelativeToMars.AccessibleDescription = "Copies to clipboard: Tisserand parameter relative to Mars";
		menuitemCopyToClipboardTisserandParameterRelativeToMars.AccessibleName = "Copy to clipboard: Tisserand parameter relative to Mars";
		menuitemCopyToClipboardTisserandParameterRelativeToMars.AccessibleRole = AccessibleRole.MenuItem;
		menuitemCopyToClipboardTisserandParameterRelativeToMars.AutoToolTip = true;
		menuitemCopyToClipboardTisserandParameterRelativeToMars.Image = (Image)resources.GetObject("menuitemCopyToClipboardTisserandParameterRelativeToMars.Image");
		menuitemCopyToClipboardTisserandParameterRelativeToMars.Name = "menuitemCopyToClipboardTisserandParameterRelativeToMars";
		menuitemCopyToClipboardTisserandParameterRelativeToMars.Size = new Size(120, 22);
		menuitemCopyToClipboardTisserandParameterRelativeToMars.Text = "&Mars";
		menuitemCopyToClipboardTisserandParameterRelativeToMars.Click += MenuitemCopyToClipboardTisserandParameterRelativeToMars_Click;
		menuitemCopyToClipboardTisserandParameterRelativeToMars.MouseEnter += Control_Enter;
		menuitemCopyToClipboardTisserandParameterRelativeToMars.MouseLeave += Control_Leave;
		// 
		// menuitemCopyToClipboardTisserandParameterRelativeToJupiter
		// 
		menuitemCopyToClipboardTisserandParameterRelativeToJupiter.AccessibleDescription = "Copies to clipboard: Tisserand parameter relative to Jupiter";
		menuitemCopyToClipboardTisserandParameterRelativeToJupiter.AccessibleName = "Copy to clipboard: Tisserand parameter relative to Jupiter";
		menuitemCopyToClipboardTisserandParameterRelativeToJupiter.AccessibleRole = AccessibleRole.MenuItem;
		menuitemCopyToClipboardTisserandParameterRelativeToJupiter.AutoToolTip = true;
		menuitemCopyToClipboardTisserandParameterRelativeToJupiter.Image = (Image)resources.GetObject("menuitemCopyToClipboardTisserandParameterRelativeToJupiter.Image");
		menuitemCopyToClipboardTisserandParameterRelativeToJupiter.Name = "menuitemCopyToClipboardTisserandParameterRelativeToJupiter";
		menuitemCopyToClipboardTisserandParameterRelativeToJupiter.Size = new Size(120, 22);
		menuitemCopyToClipboardTisserandParameterRelativeToJupiter.Text = "&Jupiter";
		menuitemCopyToClipboardTisserandParameterRelativeToJupiter.Click += MenuitemCopyToClipboardTisserandParameterRelativeToJupiter_Click;
		menuitemCopyToClipboardTisserandParameterRelativeToJupiter.MouseEnter += Control_Enter;
		menuitemCopyToClipboardTisserandParameterRelativeToJupiter.MouseLeave += Control_Leave;
		// 
		// menuitemCopyToClipboardTisserandParameterRelativeToSaturn
		// 
		menuitemCopyToClipboardTisserandParameterRelativeToSaturn.AccessibleDescription = "Copies to clipboard: Tisserand parameter relative to Saturn";
		menuitemCopyToClipboardTisserandParameterRelativeToSaturn.AccessibleName = "Copy to clipboard: Tisserand parameter relative to Saturn";
		menuitemCopyToClipboardTisserandParameterRelativeToSaturn.AccessibleRole = AccessibleRole.MenuItem;
		menuitemCopyToClipboardTisserandParameterRelativeToSaturn.AutoToolTip = true;
		menuitemCopyToClipboardTisserandParameterRelativeToSaturn.Image = (Image)resources.GetObject("menuitemCopyToClipboardTisserandParameterRelativeToSaturn.Image");
		menuitemCopyToClipboardTisserandParameterRelativeToSaturn.Name = "menuitemCopyToClipboardTisserandParameterRelativeToSaturn";
		...
		// menuitemCopyToClipboardTisserandParameterRelativeToUranus
		// 
		menuitemCopyToClipboardTisserandParameterRelativeToUranus.AccessibleDescription = "Copies to clipboard: Tisserand parameter relative to Uranus";
		menuitemCopyToClipboardTisserandParameterRelativeToUranus.AccessibleName = "Copy to clipboard: Tisserand parameter relative to Uranus";
		menuitemCopyToClipboardTisserandParameterRelativeToUranus.AccessibleRole = AccessibleRole.MenuItem;
		menuitemCopyToClipboardTisserandParameterRelativeToUranus.AutoToolTip = true;
		menuitemCopyToClipboardTisserandParameterRelativeToUranus.Image = (Image)resources.GetObject("menuitemCopyToClipboardTisserandParameterRelativeToUranus.Image");
		menuitemCopyToClipboardTisserandParameterRelativeToUranus.Name = "menuitemCopyToClipboardTisserandParameterRelativeToUranus";
		menuitemCopyToClipboardTisserandParameterRelativeToUranus.Size = new Size(120, 22);
		menuitemCopyToClipboardTisserandParameterRelativeToUranus.Text = "&Uranus";
		menuitemCopyToClipboardTisserandParameterRelativeToUranus.Click += MenuitemCopyToClipboardTisserandParameterRelativeToUranus_Click;
		menuitemCopyToClipboardTisserandParameterRelativeToUranus.MouseEnter += Control_Enter;
		menuitemCopyToClipboardTisserandParameterRelativeToUranus.MouseLeave += Control_Leave;
		// 
		// menuitemCopyToClipboardTisserandParameterRelativeToNeptune
		// 
		menuitemCopyToClipboardTisserandParameterRelativeToNeptune.AccessibleDescription = "Copies to clipboard: Tisserand parameter relative to Neptune";
		menuitemCopyToClipboardTisserandParameterRelativeToNeptune.AccessibleName = "Copy to clipboard: Tisserand parameter relative to Neptune";
		menuitemCopyToClipboardTisserandParameterRelativeToNeptune.AccessibleRole = AccessibleRole.MenuItem;
		menuitemCopyToClipboardTisserandParameterRelativeToNeptune.AutoToolTip = true;
		menuitemCopyToClipboardTisserandParameterRelativeToNeptune.Image = (Image)resources.GetObject("menuitemCopyToClipboardTisserandParameterRelativeToNeptune.Image");
		menuitemCopyToClipboardTisserandParameterRelativeToNeptune.Name = "menuitemCopyToClipboardTisserandParameterRelativeToNeptune";
		menuitemCopyToClipboardTisserandParameterRelativeToNeptune.Size = new Size(120, 22);
		menuitemCopyToClipboardTisserandParameterRelativeToNeptune.Text = "&Neptune";
		menuitemCopyToClipboardTisserandParameterRelativeToNeptune.Click += MenuitemCopyToClipboardTisserandParameterRelativeToNeptune_Click;
		menuitemCopyToClipboardTisserandParameterRelativeToNeptune.MouseEnter += Control_Enter;
		menuitemCopyToClipboardTisserandParameterRelativeToNeptune.MouseLeave += Control_Leave;
		// 
		// kryptonManager
		// 
		...
		// 
		// TisserandParameterOfOneMinorPlanetForm
		// 
		AccessibleDescription = "Shows the Tisserand parameter values of a minor planet relative to the eight solar system planets";
		AccessibleName = "Tisserand parameters of a minor planet";
		...
		MaximizeBox = false;
		MinimizeBox = false;
		Name = "TisserandParameterOfOneMinorPlanetForm";
		SizeGripStyle = SizeGripStyle.Hide;
		StartPosition = FormStartPosition.CenterScreen;
		Text = "Tisserand parameters of a minor planet";
		Load += TisserandParameterOfOneMinorPlanetForm_Load;
		Enter += Control_Enter;
		Leave += Control_Leave;
	...
	private ToolStripMenuItem menuitemCopyToClipboardTisserandParameterRelativeToEarth;
	private ToolStripMenuItem menuitemCopyToClipboardTisserandParameterRelativeToMars;
	private ToolStripMenuItem menuitemCopyToClipboardTisserandParameterRelativeToJupiter;
	private ToolStripMenuItem menuitemCopyToClipboardTisserandParameterRelativeToSaturn;
