...
namespace Planetoid_DB
{
	partial class FilterForm
	{
		...
		private void InitializeComponent()
		{
			...
			buttonResetArgumentOfThePerihelion = new KryptonButton();
			...
			tableLayoutPanel.Controls.Add(buttonResetArgumentOfThePerihelion, 3, 3);
			...
			// 
			// buttonResetArgumentOfThePerihelion
			// 
			buttonResetArgumentOfThePerihelion.AccessibleDescription = "Resets the minimum and maximum of argument of the perihelion";
			buttonResetArgumentOfThePerihelion.AccessibleName = "Reset the minimum and maximum of argument of the perihelion";
			...
			buttonResetArgumentOfThePerihelion.ToolTipValues.Heading = "Reset the minimum and maximum of argument of the perihelion";
			buttonResetArgumentOfThePerihelion.ToolTipValues.Image = FatcowIcons16px.fatcow_information_16px;
			buttonResetArgumentOfThePerihelion.Values.DropDownArrowColor = Color.Empty;
			buttonResetArgumentOfThePerihelion.Values.Image = FatcowIcons16px.fatcow_update_16px;
			buttonResetArgumentOfThePerihelion.Values.Text = "";
			buttonResetArgumentOfThePerihelion.Click += ButtonResetArgumentOfThePerihelion_Click;
			buttonResetArgumentOfThePerihelion.Enter += Control_Enter;
			buttonResetArgumentOfThePerihelion.Leave += Control_Leave;
			buttonResetArgumentOfThePerihelion.MouseEnter += Control_Enter;
			buttonResetArgumentOfThePerihelion.MouseLeave += Control_Leave;
			// 
			...
			numericUpDownMaximumArgumentOfThePerihelion.ValueChanged += NumericUpDownMaximumArgumentOfThePerihelion_ValueChanged;
			...
			numericUpDownMinimumArgumentOfThePerihelion.ValueChanged += NumericUpDownMinimumArgumentOfThePerihelion_ValueChanged;
			...
			// 
			toolStripButtonApply.AccessibleDescription = "Applies the filter settings";
			toolStripButtonApply.AccessibleName = "Apply the filter settings";
			toolStripButtonApply.AccessibleRole = AccessibleRole.PushButton;
			toolStripButtonApply.Image = FatcowIcons16px.fatcow_tick_circle_frame_16px;
			toolStripButtonApply.ImageTransparentColor = Color.Magenta;
			toolStripButtonApply.Name = "toolStripButtonApply";
			toolStripButtonApply.Size = new Size(58, 22);
			toolStripButtonApply.Text = "&Apply";
			toolStripButtonApply.Click += ButtonApply_Click;
			toolStripButtonApply.MouseEnter += Control_Enter;
			toolStripButtonApply.MouseLeave += Control_Leave;
			// 
			// toolStripButtonCancel
			// 
			toolStripButtonCancel.AccessibleDescription = "Cancels the filter settings";
			toolStripButtonCancel.AccessibleName = "Cancel the filter settings";
			...
			// 
			toolStripButtonReset.AccessibleDescription = "Resets the filter settings";
			toolStripButtonReset.AccessibleName = "Reset the filter settings";
			toolStripButtonReset.AccessibleRole = AccessibleRole.PushButton;
			toolStripButtonReset.Image = FatcowIcons16px.fatcow_update_16px;
			toolStripButtonReset.ImageTransparentColor = Color.Magenta;
			toolStripButtonReset.Name = "toolStripButtonReset";
			toolStripButtonReset.Size = new Size(70, 22);
			toolStripButtonReset.Text = "&Reset all";
			toolStripButtonReset.Click += ButtonReset_Click;
			toolStripButtonReset.MouseEnter += Control_Enter;
			toolStripButtonReset.MouseLeave += Control_Leave;
			// 
			// FilterForm
			// 
		...
		private KryptonButton buttonResetArgumentOfThePerihelion;
