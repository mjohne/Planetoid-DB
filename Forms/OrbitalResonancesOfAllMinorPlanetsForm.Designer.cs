/*
 * File:        OrbitalResonancesOfAllMinorPlanetsForm.Designer.cs
 * Project:     Planetoid-DB
 * Namespace:   Planetoid_DB
 * Description: Represents a dialog form that displays orbital resonances of all minor planets relative to the eight solar system planets.
 * Remarks:     This file contains the Windows Forms designer-generated code for the OrbitalResonancesOfAllMinorPlanetsForm. Do not modify this file manually.
 *
 * Autor:       Michael Johne
...
/// <summary>Represents a dialog form that displays orbital resonances of all minor planets relative to the eight solar system planets.</summary>
/// <remarks>This form allows users to select which planets to include in the resonance search and provides a progress indicator during the search process. Results are presented in a list view, and users can copy information to the clipboard via a context menu. The form is designed for modal display and does not appear in the taskbar.</remarks>
partial class OrbitalResonancesOfAllMinorPlanetsForm
{
	...
	private void InitializeComponent()
	{
		...
		toolStripContainer.RightToolStripPanel.AccessibleName = "Rigth panel";
