...
namespace Planetoid_DB
{
	partial class OrbitalResonancesOfAllMinorPlanetsForm
	{
		...
		private void InitializeComponent()
		{
			...
			panel.Controls.Add(checkBoxMercury);
			panel.Controls.Add(checkBoxVenus);
			panel.Controls.Add(checkBoxEarth);
			panel.Controls.Add(checkBoxMars);
			panel.Controls.Add(checkBoxJupiter);
			panel.Controls.Add(checkBoxSaturn);
			panel.Controls.Add(checkBoxUranus);
			panel.Controls.Add(checkBoxNeptune);
			panel.Controls.Add(kryptonProgressBar);
			...
			checkBoxMercury.Size = new Size(110, 19);
			...
			checkBoxVenus.Size = new Size(90, 19);
			...
			checkBoxEarth.Size = new Size(85, 19);
			...
			checkBoxMars.Size = new Size(85, 19);
			...
			checkBoxJupiter.Size = new Size(110, 19);
			...
			checkBoxSaturn.Size = new Size(90, 19);
			...
			checkBoxUranus.Size = new Size(90, 19);
			...
			checkBoxNeptune.Size = new Size(100, 19);
			...
			listView.Size = new Size(876, 493);
