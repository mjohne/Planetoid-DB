...
partial class Orbits2DSideViewForm
{
	/// <summary>Required designer variable.</summary>
	/// <remarks>This field stores the components used by the form.</remarks>
	private IContainer components = null;

	/// <summary>Releases all resources used by the <see cref="Orbits2DSideViewForm"/>.</summary>
	...
	/// <remarks>This method sets up the controls and their properties for the Orbits2DSideViewForm. It is automatically generated by the Windows Forms designer and should not be modified manually.</remarks>
	private void InitializeComponent()
	{
		components = new Container();
		ComponentResourceManager resources = new ComponentResourceManager(typeof(Orbits2DSideViewForm));
