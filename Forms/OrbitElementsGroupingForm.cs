...
public partial class OrbitElementsGroupingForm : BaseKryptonForm
{
	...
	/// <summary>Gets the text box used for export operations.</summary>
	/// <remarks>Overrides the base export source to use this form's output text box.</remarks>
	protected override TextBox? ExportTextBox => kryptonTextBoxOutput.TextBox;
	...
	protected override string ExportTitle => "Orbit Elements Grouping";
	...
	protected override string ExportFilePrefix => "Orbit-Elements-Grouping";
