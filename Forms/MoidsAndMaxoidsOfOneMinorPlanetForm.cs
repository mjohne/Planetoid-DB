/*
 * File:        MoidsAndMaxoidsOfOneMinorPlanetForm.cs
 * Project:     Planetoid-DB
 * Namespace:   Planetoid_DB
 * Description: Form for displaying the Minimum Orbit Intersection Distance (MOID) and Maximum Orbit Intersection Distance (MAXOID) of a minor planet relative to each of the eight solar system planets.
 *
