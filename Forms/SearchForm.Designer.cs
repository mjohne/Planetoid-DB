...
/// <summary>Represents a dialog form that enables users to search for words, keywords, or numbers within the application.</summary>
/// <remarks>The SearchForm provides a user interface for entering search criteria and displays the results of the
/// search. It includes options for marking and unmarking search elements, clearing input, and loading selected results.
/// The form is designed to facilitate efficient searching and result management in a structured manner.</remarks>
