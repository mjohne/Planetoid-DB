/*
 * File:        DatabaseInformationForm.Designer.cs
...
/// <summary>Represents a Windows Form that displays detailed information about a database, including its name, path, size, creation date, last access date, last write date, and attributes.</summary>
/// <remarks>DatabaseInformationForm provides a user interface for viewing and copying database information. Users can interact with labels to copy information to the clipboard or save it to a file in various formats. The form is intended to be used as a dialog and does not appear in the taskbar. Controls are organized for accessibility and usability, supporting keyboard shortcuts and context menus for efficient data export.</remarks>
