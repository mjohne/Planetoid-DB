 ...
 * Description: Exports database information to a text file.
 *
...
/// <summary>Represents a text exporter for exporting database information to a text file.</summary>
/// <remarks>This class implements the IOrbitDataExporter interface and provides functionality to export database information to a text file format.</remarks>
// You can customize the debugger display for this class by providing a property that returns a string representation of the instance, which will be shown in the debugger when you inspect an object of this class. In this case, the DebuggerDisplay property is used to return a string representation of the instance, and the DebuggerDisplay attribute is applied to the class to specify that this property should be used for the debugger display.
[DebuggerDisplay(value: $"{{{nameof(DebuggerDisplay)},nq}}")]
internal class TextExporter : IOrbitDataExporter
{
	/// <summary>NLog logger instance for the class.</summary>
	/// <remarks>This logger is used to log messages for the class.</remarks>
	private static readonly Logger logger = LogManager.GetCurrentClassLogger();

	/// <summary>Initializes a new instance of the TextExporter class.</summary>
	/// <remarks>This constructor initializes a new instance of the TextExporter class.</remarks>
	...
	public void Export(string filePath, string exportTitle, Dictionary<string, string> selectedData)
	{
		...
		logger.Info(message: $"Exporting data to text file: {filePath}");
		// Create a StringBuilder to build the content of the text file
		StringBuilder sb = new();
		// Append the export title and a separator line to the StringBuilder
		_ = sb.AppendLine(value: exportTitle);
		_ = sb.AppendLine(value: new string(c: '-', count: exportTitle.Length));
		...
		logger.Info(message: $"Data exported successfully to text file: {filePath}");
	}
}