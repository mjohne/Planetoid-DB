 ...
 * Description: Exports database information to a CSV file.
 *
...
public class CsvExporter : IOrbitDataExporter
{
	...
	public string Title => "Save database information as CSV";
	...
	/// <remarks>This method exports the selected data to a CSV file at the specified file path.</remarks>
	public void Export(string filePath, string exportTitle, Dictionary<string, string> selectedData)
	{
		// Log the export operation
		logger.Info(message: $"Exporting data to CSV file: {filePath}");
		...
		logger.Info(message: $"Data exported successfully to CSV file: {filePath}");
	}
}