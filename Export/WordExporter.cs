...
internal class WordExporter : IOrbitDataExporter
{
	...
	/// <summary>Escapes special XML characters in a string to ensure it can be safely included in an XML document.</summary>
	/// <param name="value">The string value to escape.</param>
	/// <returns>The escaped string.</returns>
	/// <remarks>This method replaces special XML characters with their corresponding escape sequences to prevent XML parsing errors.</remarks>
