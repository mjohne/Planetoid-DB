...
internal class PostscriptExporter : IOrbitDataExporter
{
	...
	/// <summary>Escapes special characters in a string for use in PostScript.</summary>
	/// <param name="value">The string value to escape.</param>
	/// <returns>The escaped string value.</returns>
	/// <remarks>This method replaces special characters in the input string with their corresponding PostScript escape sequences.</remarks>
