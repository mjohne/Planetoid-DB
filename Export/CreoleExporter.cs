/*
 * File:        CreoleExporter.cs
 * Project:     Planetoid-DB
 * Namespace:   Planetoid_DB.Export
 * Description: Exports database information to a Creole file.
 *
...
/// <summary>Represents a Creole exporter for exporting database information to a Creole file.</summary>
/// <remarks>This class implements the IOrbitDataExporter interface and provides functionality to export database information to a Creole file format.</remarks>
// You can customize the debugger display for this class by providing a property that returns a string representation of the instance, which will be shown in the debugger when you inspect an object of this class. In this case, the DebuggerDisplay property is used to return a string representation of the instance, and the DebuggerDisplay attribute is applied to the class to specify that this property should be used for the debugger display.
[DebuggerDisplay(value: "{" + nameof(DebuggerDisplay) + ",nq}")]
internal class CreoleExporter : IOrbitDataExporter
{
	/// <summary>NLog logger instance for the class.</summary>
	/// <remarks>This logger is used to log messages for the class.</remarks>
	private static readonly Logger logger = LogManager.GetCurrentClassLogger();

	/// <summary>Initializes a new instance of the CreoleExporter class.</summary>
	/// <remarks>This constructor initializes a new instance of the CreoleExporter class.</remarks>
	public string Extension => "creole";
	...
	public string Filter => "Creole files (*.creole)|*.creole|All files (*.*)|*.*";
	...
	public string Title => "Save database information as Creole";
	...
	/// <summary>Exports the selected data to a Creole file.</summary>
	/// <param name="filePath">The path of the file to export to.</param>
	/// <param name="exportTitle">The title of the export.</param>
	/// <param name="selectedData">The data to be exported.</param>
	/// <remarks>This method exports the selected data to a Creole file at the specified file path.</remarks>
	public void Export(string filePath, string exportTitle, Dictionary<string, string> selectedData)
	{
		// Log the export operation
		logger.Info(message: $"Exporting data to Creole file: {filePath}");
		// Create a StringBuilder to build the content of the Creole file
		StringBuilder sb = new();
		// Append the export title and a separator line to the StringBuilder
		_ = sb.AppendLine(value: $"== {exportTitle}");
